...
const CommentsForm = ({ slug }) => {
    ...
    return (
        <div className = 'bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            ...
            <div className = 'grid grid-cols-1 gap-4 mb-4'>
                <div>
                    <input type="checkbox" ref = {storeDataElement} id = 'storeData' name ='storeData' value = 'true' /> 
            ...
            {error && <p className = 'text-xs px-4 text-red-500'>All fields are required!!</p>}
            <div className="mt-8">
                <button 
                    type = 'button' 
                    onClick = {handleSubmit} 
                    className = 'transitio duration-500 ease hover:bg-indigo-900 inline-block bg-pink-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer'
                >
                   Post Comment 
                </button>
